			<main class="main">
				...
				<div class="body flex-grow-1 px-3">
					<div class="container-lg">						<div class="card mb-4">
							<div class="card-body rmi-container">								<!-- Tabbed Interface -->
								...
								<!-- Tab Content -->
								<div class="tab-content rmi-tab-content" id="rmiTabContent">
									<!-- Penilaian Tab -->
									<div class="tab-pane show active" id="penilaian" role="tabpanel" aria-labelledby="penilaian-tab">
										...
										<!-- Modern Card Layout for Parameters -->
										<div class="rmi-parameters-container">
											<?php if (!empty($rmi_data)): ?>
												<?php foreach ($rmi_data as $dimensi => $sub_dimensi_array): ?>
													<?php foreach ($sub_dimensi_array as $sub_dimensi => $parameters): ?>
														<?php foreach ($parameters as $param_data): ?>
															<?php 
															...
															<!-- Parameter Card -->
															<div class="card rmi-parameter-card mb-4" data-parameter="<?= $parameter_key ?>" data-total-points="<?= $total_points_count ?>">
																...
																<div class="card-body">
																	...
																	<div class="progress-score-area mb-4">
																		<div class="progress-wrapper">
																			<div class="d-flex justify-content-between align-items-center mb-2">
																				<small class="text-muted">Progres Checklist</small>
																						...
																						<h6 class="mb-0">
																							<button class="btn btn-link rmi-phase-header w-100 text-left <?= $is_first_phase ? '' : 'collapsed' ?>" 
																								...
																								<div class="d-flex align-items-center justify-content-between w-100">
																									<div class="rmi-phase-title d-flex align-items-center">
											...
											<?php else: ?>
												<div class="alert alert-info text-center">
													<i class="icon-info mr-2"></i>													No RMI data available. Please check if the CSV file exists.
												</div>
											<?php endif; ?>
										</div>
									</div>
