<script type="text/javascript">
    $(function() {
        ...
        // var base_url = 'https://ahlimr.com/index.php'; // Here i define the base_url
        ...
        $('#calendar').fullCalendar({
            ...
            events: base_url + 'renja/getEvents',
            selectable: true,
            selectHelper: true,
            ...
            eventDrop: function(event, delta, revertFunc, start, end) {
                ...
                $.post(base_url + 'renja/dragUpdateEvent', {
                    id: event.id,
                    start: start,
                    end: end
                }, function(result) {
        ...
        $('.modal').on('click', '#update-event', function(e) {
            if (validator(['title', 'description'])) {
                $.post(base_url + 'renja/updateEvent', {
                    id: currentEvent._id,
                    title: $('#title').val(),
                    description: $('#description').val(),
                    pic: $('#pic').val(),
        ...
        $('.modal').on('click', '#delete-event', function(e) {
            $.get(base_url + 'renja/deleteEvent?id=' + currentEvent._id, function(result) {
