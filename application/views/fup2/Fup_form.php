                        ...
                        <div class="card-body">
                            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="judul" id="judul"><?php echo $judul; ?> </textarea>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="tempat" id="tempat"><?php echo $tempat; ?>
                                </div>
                                <br>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="pic_narasumber" id="pic_narasumber"><?php echo $pic_narasumber; ?>
                                </div>
