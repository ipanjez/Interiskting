                        ...
                        <div class="card-body">
                            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="judul_kejadian" id="judul_kejadian" value="<?php echo $judul_kejadian; ?>">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="risiko" id="risiko" value="<?php echo $risiko; ?>">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="no_item" id="ckeditor3" value="<?php echo $no_item; ?>"> </input>
                                </div>
                                <br>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="penanggung_jawab" id="penanggung_jawab" value="<?php echo $penanggung_jawab; ?>">
                                </div>
                                <br>
