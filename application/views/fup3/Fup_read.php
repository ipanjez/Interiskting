                        ...
                        <div class="card-body">
                            <table class="table table-responsive-sm table-striped " id="mytable">
                                ...
                                <tr>
                                    ...
                                    <td>: <?php echo $no_surat_out; ?></td>
                                </tr>
                                <tr>
                                    <td>Tanggal Surat Keluar</td>
                                    <td>: <?php echo $tgl_out; ?></td>
                                </tr>
                                <tr>
                                    <td>Keterangan :</td>
                                    <td><?php echo $ket; ?></td>
                                ...
                                <tr>
                                    <td>Download Critical Path</td>
                                    <td>: <a href="<?php echo base_url(); ?>/uploads/<?php echo $nama_file; ?>" target=_blank><?php echo $nama_file; ?></a></td>
                                </tr>
                                <tr>
                                    <td><a href="<?php echo site_url('fup3') ?>" class="btn bg-danger">Kembali</a></td>
                                </tr>
