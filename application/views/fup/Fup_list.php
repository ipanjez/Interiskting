        ...
        <form id="myform" method="post" onsubmit="return false">
          <div class="row" style="margin-bottom: 10px">
            <div class="col-xs-12 col-md-4">
              <?php echo anchor(site_url('fup/create'), '<i class="fa fa-plus"></i> Create', 'class="btn btn-primary"'); ?>
            </div>
            ...
            <div class="col-xs-12 col-md-4 text-right">
              <?php echo anchor(site_url('fup/excel'), '<i class="fa fa-file-excel"></i> Excel', 'class="btn btn-success"'); ?>
            </div>
          </div>
