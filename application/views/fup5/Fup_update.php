                        ...
                        <div class="card-body">
                            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="tugas" id="tugas" value="<?php echo $tugas; ?>">
                                </div>
                                <br>
                                <div class="form-group">
                                    <label for="varchar">PIC :<?php echo form_error('pic') ?></label>
                                    <input class="form-control" name="pic" id="pic" value="<?php echo $pic; ?>">
                                </div>
                                <br>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="ckeditor" name="resume" id="ckeditor1" value="<?php echo $resume; ?>"></textarea>
                                </div>
                                <br>
                                <div class="form-group ">
