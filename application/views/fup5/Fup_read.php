                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table class="table table-responsive-sm table-striped " id="mytable">
                                ...
                                <tr>
                                    <td><a href="<?php echo site_url('fup5') ?>" class="btn bg-danger">Kembali</a></td>
                                </tr>
                                ...
                                <div class="chart" id="comments">
                                    ...
                                    foreach ($commentfup5 as $value) {
                                        ...
                                        if ($_SESSION['user_id'] === $value->id_users) {
                                            print "<a href=" . site_url() . "commentfup5/delete/" . $value->id . "/" . $id . ">" . " Hapus" . "</a>";
                                        };
                                        print "</li>";
                                    } ?>
                                    <br />
                                    ...
                                    <form action="<?= site_url('commentfup5') ?>" method="post">

                                        <textarea class="ckeditor" id="ckeditor" rows="6" cols="65" name="catatan"></textarea>
            ...
            <div class="row ">
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h1>Update / Revisi</h1>
                            <form method="POST" action="<?php echo base_url('commentpdu5') ?>" enctype="multipart/form-data">
                            ...
                            <div class="file-list">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <?php $no = 1; ?>
                                        <?php foreach ($commentpdu5 as $file) : ?>
                                            <tr>
                                                <td><?php echo $no++; ?></td>
                                                ...
                                                <td><?php if ($_SESSION['user_id'] === $file->id_users) {
                                                        print "<a href=" . site_url() . "commentpdu5/delete/" . $file->id . "/" . $id . ">" . " Hapus" . "</a>";
                                                    }; ?></td>
                                            </tr>
                                        <?php endforeach; ?>
                                        </tr>
