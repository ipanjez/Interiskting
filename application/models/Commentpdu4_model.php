...
class Commentpdu4_model extends CI_Model
{
    ...
    {
        $this->db->insert('commentpdu4', $data);
    }
    ...
    //public function hae_kommentit($id)
    {
        ...
        //poistoa varten
        //untuk dihapus
        $this->db->select('*, commentpdu4.id as id');
        $this->db->from('commentpdu4');
        $this->db->join('users', 'users.id = commentpdu4.id_users');
