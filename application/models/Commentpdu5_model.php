...
class Commentpdu5_model extends CI_Model
{
    ...
    {
        $this->db->insert('commentpdu5', $data);
    }
    ...
    //public function hae_kommentit($id)
    {
        ...
        //poistoa varten
        //untuk dihapus
        $this->db->select('*, commentpdu5.id as id');
        $this->db->from('commentpdu5');
        $this->db->join('users', 'users.id = commentpdu5.id_users');
