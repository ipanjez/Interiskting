...
class Commentfup4_model extends CI_Model
{
    ...
    {
        $this->db->insert('commentfup4', $data);
    }
    ...
    //public function hae_kommentit($id)
    {
        ...
        //poistoa varten
        //untuk dihapus
        $this->db->select('*, commentfup4.id as id');
        $this->db->from('commentfup4');
        $this->db->join('users', 'users.id = commentfup4.id_users');
