...
class Commentfup5_model extends CI_Model
{
    ...
    {
        $this->db->insert('commentfup5', $data);
    }
    ...
    //public function hae_kommentit($id)
    {
        ...
        //poistoa varten
        //untuk dihapus
        $this->db->select('*, commentfup5.id as id');
        $this->db->from('commentfup5');
        $this->db->join('users', 'users.id = commentfup5.id_users');
