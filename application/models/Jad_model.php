...
class Jad_model extends CI_Model
{
    ...
    public function addEvent()
    {
         ...
         $sql = "INSERT INTO events (title,events.start,events.end,description,pic,link,waktu,target,tls,color) VALUES (?,?,?,?,?,?,?,?,?,?)";
    ...
    public function updateEvent()
    {
        ...
        $sql = "UPDATE events SET title = ?, description = ?,  pic = ?, link = ?, waktu = ?, target = ?, tls = ?, color = ? WHERE id = ?";
